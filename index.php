            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?= $featured_product['image']?>" alt="" />
                    ...
                    <div class="text-center py-4">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?= $featured_product['price'] - $featured_product['price']*$featured_product['discount'] ?></h5>
                            <h6 class="text-muted ml-2"><del><?= $featured_product['price'] ?></del></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mb-1">
                        <?php for($i = 0; $i<= $featured_product['rating']; $i++){
